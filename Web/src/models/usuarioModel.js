...
function cadastrarParametro(fkEmpresa){
        ...
        var instrucao = `
            INSERT INTO parametros (nome, alertaCPU, criticoCPU, alertaDISCO, criticoDISCO, alertaRAM, criticoRAM, fk_empresa) VALUES ('Parâmetro padrão', 80, 100, 80, 100, 80, 100, ${fkEmpresa});
        `;
